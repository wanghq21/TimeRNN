...
from layers.duet_masked_attention import Mahalanobis_mask, Encoder, EncoderLayer, FullAttention, AttentionLayer
...
class Model(nn.Module):
    ...
    def forward(self, input, x_mark_enc, x_dec, x_mark_dec, mask=None):
